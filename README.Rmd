...
- name: Shannon E. Ellis
  ...
  affiliation: Department of Biostatistics, Johns Hopkins Bloomberg School of Public Health and Center for Computational Biology, Johns Hopkins University and Center for Computational Biology, Johns Hopkins University
...
* The complicated JSON [json_2017] data you got from scraping the Twitter API [@noauthor_twitter_nodate]
...
Alternatively, in many cases, the person who collected the data may not know how to code in a scripting language. However, he or she still has incentive to make the data tidy for a statistician to speed the process of collaboration. In this case, the statistician should be provided something called pseudocode [_pseudocode_2017] (**Figure \ref{fig1}D**). It should look something like:
